public sealed record QBE : HL7Data {
    public override string Name => nameof(QBE);
    ...
    private QBE(Segment segment) : base(segment) {
    ...
    static QBE() {
        SegmentLoader.Register("QBE", segment => new QBE(segment));
    }
}