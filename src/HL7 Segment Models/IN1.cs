...
public sealed record IN1 {
    ...
    public static IN1 Load(Segment segment) {
        if (segment.Name != "IN1") throw new InvalidDataException($"Invalid Segment - Primary Insurance Data is in IN1 Segment, this is {segment.Name}");
