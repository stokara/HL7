public sealed record PID : HL7Data {
    public override string Name => nameof(PID);
    ...
    private PID(Segment segment) : base(segment) {
    ...
    static PID() {
        SegmentLoader.Register("PID", segment => new PID(segment));
    }
}