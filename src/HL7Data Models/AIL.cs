...
/// <summary>
///     AIL - Appointment Information - Location Resource Segment (HL7 v2.3.1)
/// </summary>
public sealed record AIL : HL7Data<AIL> {
    public string SetId { get; }
    public string SegmentActionCode { get; }
    public string LocationResourceId { get; }
    public string LocationType { get; }
    public string LocationGroup { get; }
    ...
    public AIL(Segment segment) : base(segment) {
        ...
        LocationResourceId = cnt > 3 ? fields[3].Value : string.Empty;
        LocationType = cnt > 4 ? fields[4].Value : string.Empty;
        LocationGroup = cnt > 5 ? fields[5].Value : string.Empty;
